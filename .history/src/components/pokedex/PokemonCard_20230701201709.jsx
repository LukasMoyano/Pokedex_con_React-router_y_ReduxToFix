...
<article className="flex flex-col mb-4">
  <section
    className={`relative h-40 ${pokeLinearGradients[pokemon?.types[0]?.type?.name]}`}
  >
    <div className="absolute px-5 -botton-2">
      <img
  ...
  {/* Sección inferior */}
  <section>
    <h3 className="mx-auto items-center capitalize hover:uppercase text-center font-bold text-3xl mt-20">
