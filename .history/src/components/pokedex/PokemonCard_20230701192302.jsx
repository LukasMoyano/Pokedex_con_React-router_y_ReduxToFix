...
<article className="flex flex-col mb-4">
  ...
  <section>
  <h3 className="flex w-40 h-4 flex-col justify-center items-center">
    {/* NOMBRE DEL POKEMON - colocar color */}
    {pokemon?.name}
  </h3>
  {/* Tipo de pokemon - centrado y agrandar letras */}
  <span className="flex w-56 h-10 flex-col justify-center">
    Type
  </span>
  <h5 className="flex w-119 h-10 flex-col justify-center">
