...
const getColorData = async (id Or Name) => {
  try {
    const response = await axios.get(`https://pokeapi.co/api/v2/pokemon-color/${id Or Name}`);
...
const getTypeData = async (id Or Name) => {
  try {
    const response = await axios.get(`https://pokeapi.co/api/v2/type/${id Or Name}`);
    return response.data;
  } catch (error) {
    console.log(error);
    throw error;
