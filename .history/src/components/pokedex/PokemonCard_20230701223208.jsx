...
<article className="flex flex-col mb-4">
  <section className={`relative h-40 ${pokeLinearGradients[pokemon?.types[0]?.type?.name]}`}>
    <div className="px-5 -botton-2 w-full h-full flex flex-col justify-center items-center">
      <img
        className="w-173 h-17 object-contain flex-shrink-0"
  ...
  <section className={`${window.innerHeight <= 400 ? 'flex flex-col' : 'flex'}`}>
    ...
    {/* TYPE */}
    <span className="flex items-center justify-center w-119 h-10">Type</span>
