...
const pokeLinearGradients = {
  ...
  water: "rounded-t-md bg-gradient-to-b from-custom-gradient via-custom-gradient to-custom-gradient",
  bug: "rounded-t-md bg-gradient-to-b from-custom-gradient via-custom-gradient to-custom-gradient",
