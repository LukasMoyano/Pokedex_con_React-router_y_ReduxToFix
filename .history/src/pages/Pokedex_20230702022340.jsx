  ...
  <button className="">
    <span className="relative px-6 py-4 transition-all ease-in duration-200 bg-white rounded-md group-hover:bg-opacity-0">
      Gradient
          ...
          <button className="flex-shrink-0 w-56 h-2 bg-red-600 text-white font-medium rounded-lg text-base px-6 py-4 text-center mr-2 mb-0 active:scale-95 duration-300">Search</button>
        </div>
